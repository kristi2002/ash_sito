...
//  Pagina servizio: Finiture ad Intonachino — PHP + Bootstrap 5
// ============================================================
...
$servizio_titolo = 'Finiture ad intonachino';
$servizio_slug   = 'intonachino';
...
$lavorazioni = [
    ...
    ['icona' => 'bi-palette',      'testo' => 'Colori personalizzati'],
    ['icona' => 'bi-shield-check', 'testo' => 'Finiture ai silossani'],
];

// Perché A.S.H.: la nostra firma sull'intonachino
$motivi = [
    ['icona' => 'bi-gem',          'titolo' => 'Effetto materico',   'testo' => 'Texture ed eleganza che una pittura non può dare'],
    ['icona' => 'bi-brush',        'titolo' => 'Mano artigianale',   'testo' => 'Stesura e frattazzatura curate parete per parete'],
    ['icona' => 'bi-palette',      'titolo' => 'Colore su misura',   'testo' => 'Tinte in pasta personalizzate, campionate dal vivo'],
    ['icona' => 'bi-shield-check', 'titolo' => 'Resistenza reale',   'testo' => 'Superfici dure, lavabili e protette dagli agenti'],
];

// Il ciclo dell'intonachino: quattro fasi, dal fondo alla texture
$fasi_ciclo = [
    ['fase' => '01', 'titolo' => 'Preparazione del fondo',    'testo' => 'Verifica del supporto, rasature dove serve e superfici piane e pulite: la texture esalta anche i difetti del fondo.'],
    ['fase' => '02', 'titolo' => 'Primer pigmentato',         'testo' => 'Fondo ancorante colorato in tinta con la finitura: garantisce aggancio e copertura uniforme dell\'intonachino.'],
    ['fase' => '03', 'titolo' => 'Stesura dell\'intonachino', 'testo' => 'Applicazione a frattazzo in spessore uniforme, lavorando pareti intere senza interruzioni per evitare riprese visibili.'],
    ['fase' => '04', 'titolo' => 'Texture e finitura',        'testo' => 'Frattazzatura finale che dà l\'effetto desiderato: il gesto artigianale che firma la parete, uniforme anche in luce radente.', 'firma' => true],
];

// Dove interveniamo: contesti tipici, raccontati come card premium con foto della tipologia
$applicazioni = [
    ['icona' => 'bi-house-door',   'titolo' => 'Abitazioni private',    'foto' => '../assets/img/servizi/spazio-abitazioni.jpg',   'testo' => 'Pareti d\'accento e ambienti interi con finiture materiche che scaldano gli spazi.'],
    ['icona' => 'bi-building',     'titolo' => 'Facciate ed esterni',   'foto' => '../assets/img/servizi/spazio-facciate.jpg',     'testo' => 'Intonachini ai silossani che vestono la facciata e la proteggono da pioggia, sole e smog.'],
    ['icona' => 'bi-droplet-half', 'titolo' => 'Bagni e cucine',        'foto' => '../assets/img/servizi/spazio-bagni-cucine.jpg', 'testo' => 'Finiture continue e resistenti all\'umidità, eleganti anche in alternativa alle piastrelle.'],
    ['icona' => 'bi-briefcase',    'titolo' => 'Uffici e studi',        'foto' => '../assets/img/servizi/spazio-uffici.jpg',       'testo' => 'Superfici di carattere per ingressi, sale riunioni e spazi di rappresentanza.'],
    ['icona' => 'bi-shop',         'titolo' => 'Negozi e locali',       'foto' => '../assets/img/servizi/spazio-negozi.jpg',       'testo' => 'Pareti scenografiche che valorizzano prodotti e ambienti, resistenti al passaggio.'],
    ['icona' => 'bi-buildings',    'titolo' => 'Vani scala e condomini','foto' => '../assets/img/servizi/spazio-condomini.jpg',    'testo' => 'Parti comuni di pregio, con superfici dure, lavabili e facili da mantenere.'],
];

// FAQ
$faq = [
    [
        'domanda'  => 'Che differenza c\'è tra intonachino e pittura?',
        'risposta' => 'La pittura è un film sottile di colore; l\'intonachino è un rivestimento in spessore che dona materia e texture alla parete. Oltre all\'effetto estetico, offre maggiore resistenza a urti e sfregamenti e maschera le piccole imperfezioni del fondo.',
    ],
    [
        'domanda'  => 'L\'intonachino è adatto a bagni e cucine?',
        'risposta' => 'Sì, con i prodotti giusti: utilizziamo finiture specifiche per ambienti umidi, resistenti a vapore e condensa, eventualmente protette con trattamenti idrorepellenti. È un\'alternativa elegante alle piastrelle, previa valutazione del supporto.',
    ],
    [
        'domanda'  => 'Quanto dura un intonachino su una facciata?',
        'risposta' => 'Un intonachino ai silossani ben applicato protegge la facciata per 15-20 anni e oltre, resistendo a pioggia, raggi UV e smog meglio di una semplice pittura. La durata dipende molto dalla preparazione del fondo, che per noi è la fase più importante del ciclo.',
    ],
    [
        'domanda'  => 'Posso scegliere colore ed effetto?',
        'risposta' => 'Sì: colori in pasta personalizzati, grane fini o medie ed effetti dal liscio spatolato al rustico. Prima di iniziare realizziamo una campionatura direttamente sulla tua parete, così scegli dal vivo con la luce reale dell\'ambiente.',
    ],
];
...
$json_ld = [
    [
        ...
        '@type'       => 'Service',
        'name'        => 'Finiture ad Intonachino',
        'serviceType' => 'Finiture decorative ad intonachino per interni e facciate: effetti materici, grane e colori personalizzati',
        'description' => 'Finiture decorative ad intonachino per interni ed esterni: texture, colori su misura e protezione delle facciate a Camerino (MC) e provincia di Macerata.',
    ...
    [
        ...
        'itemListElement' => [
            ...
            ['@type' => 'ListItem', 'position' => 3, 'name' => 'Intonachino'],
        ],
    ],
];
?>
...
<head>
    ...
    <title>Finiture ad Intonachino a Camerino e Macerata | A.S.H. Finiture Contract</title>
    <meta name="description" content="Finiture decorative ad intonachino per interni e facciate: effetti materici, grane e colori personalizzati. Sopralluogo e preventivo gratuiti a Camerino (MC) e provincia.">
...
<body>
                ...
                <div class="col-lg-9">
                    <nav aria-label="Percorso di navigazione" class="fade-up">
                        <ol class="breadcrumb-servizio list-unstyled">
                            ...
                            <li class="separatore" aria-hidden="true"><i class="bi bi-chevron-right"></i></li>
                            <li class="corrente" aria-current="page">Intonachino</li>
                        </ol>
                    </nav>
                    <span class="hero-badge fade-up delay-1 mt-3">
                        <i class="bi bi-brush"></i> Il nostro servizio
                    </span>
                    <h1 class="mt-3 fade-up delay-1">
                        Finiture ad <span class="gold">intonachino</span>
                    </h1>
                    <p class="lead mt-3 fade-up delay-2">
                        Materia, texture e colore: finiture decorative che danno carattere alle pareti e proteggono le facciate.
                    </p>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6 reveal">
                    ...
                    <h2 class="section-title mt-3">La materia giusta,<br><span class="text-oro">stesa ad arte</span></h2>
                    <div class="title-underline a-sinistra"></div>
                    <p class="mt-4">
                        Vestiamo le tue pareti con <strong>finiture materiche di pregio</strong>:
                        fondi preparati con cura, <strong>colori personalizzati</strong> e texture
                        uniformi, senza riprese visibili. Ogni progetto parte da un sopralluogo
                        gratuito con campionatura dal vivo.
                    </p>
                ...
                <div class="col-lg-6 reveal" style="transition-delay:.15s">
                    <div class="composizione-foto">
                        <img class="foto-principale"
                             src="<?php echo $foto_cantiere_url[26] ?? '../assets/img/card-servizio-bg.jpg'; ?>"
                             alt="Ambiente rifinito ad intonachino da A.S.H. Finiture Contract"
                             loading="lazy">
                        <?php if (isset($foto_cantiere_url[0])): ?>
                        <img class="foto-secondaria"
                             src="<?php echo $foto_cantiere_url[0]; ?>"
                             alt="Dettaglio di una finitura decorativa in un cantiere A.S.H."
                             loading="lazy">
                        <?php endif; ?>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6 reveal">
                    <div class="mini-mosaico-wrap">
                        ...
                        <div class="mini-mosaico">
                            <?php foreach (array_slice($foto_cantiere_url, 2, 4) as $i => $src): ?>
                            <figure>
                                <img src="<?php echo $src; ?>"
                                     alt="Finitura ad intonachino realizzata da A.S.H. Finiture Contract"
                                     loading="lazy">
                            </figure>
                            <?php endforeach; ?>
                        </div>
                ...
                <div class="col-lg-6 reveal" style="transition-delay:.15s">
                    ...
                    <h2 class="section-title mt-3">La nostra firma,<br><span class="text-oro">in ogni texture</span></h2>
                    <div class="title-underline a-sinistra"></div>
                    <p class="mt-4">
    ...
    <!-- ================= IL CICLO DELL'INTONACHINO IN 4 FASI ================= -->
    <section id="ciclo">
        ...
        <div class="container">
            <div class="text-center mb-5 reveal">
                ...
                <p class="mt-3 mx-auto" style="max-width: 660px;">
                    La texture è solo l'ultimo gesto: il risultato si costruisce prima.
                    Ogni intonachino segue un ciclo preciso in quattro fasi &mdash;
                    ed è nella frattazzatura finale che si vede la mano artigianale.
                </p>
            </div>
            <div class="row g-4 pt-2 align-items-stretch">
                <div class="col-lg-5 reveal">
                    <div class="foto-ciclo">
                        <img src="<?php echo $foto_cantiere_url[6] ?? '../assets/img/servizi/spazio-abitazioni.jpg'; ?>"
                             alt="Applicazione dell'intonachino a frattazzo in un cantiere A.S.H."
                             loading="lazy">
                        <div class="velo" aria-hidden="true"></div>
                        <span class="badge-qualita">
                            <i class="bi bi-brush" aria-hidden="true"></i> Il ciclo in cantiere
                        </span>
                        <div class="didascalia">
                            <h5>Gesto dopo gesto</h5>
                            <p>Dal fondo pigmentato alla frattazzatura finale: l'effetto materico nasce da un ciclo rispettato.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
    ...
    <section id="applicazioni">
        <div class="container">
            <div class="text-center mb-5 reveal">
                ...
                <h2 class="section-title mt-3">Ogni spazio, <span class="text-oro">la sua materia</span></h2>
                <div class="title-underline"></div>
                <p class="mt-3 mx-auto" style="max-width: 640px;">
                    Dalla parete d'accento alla facciata intera: questi sono i contesti
                    in cui l'intonachino dà più carattere.
                </p>
            </div>
            <div class="row g-4">
                    ...
                    <div class="card-applicazione">
                        <div class="foto-applicazione">
                            <img src="<?php echo $applicazione['foto']; ?>"
                                 alt="<?php echo $applicazione['titolo']; ?> — finiture ad intonachino A.S.H. Finiture Contract"
                                 loading="lazy">
                        </div>
        ...
        <div class="container">
            <div class="row align-items-center g-4">
                <div class="col-lg-7 reveal">
                    <h2 class="mb-2">Hai un progetto con l'intonachino?</h2>
                    <p class="fs-5 mb-4" style="color:rgba(255,255,255,.9)">
                        <em>"<?php echo $tagline; ?>"</em> — richiedi subito un
                        <strong>preventivo gratuito</strong> e senza impegno per le tue finiture decorative.
                    </p>
    ...
    <section id="faq">
        <div class="container">
            <div class="text-center mb-5 reveal">
                ...
                <h2 class="section-title mt-3">FAQ sull'Intonachino</h2>
                <div class="title-underline"></div>
            </div>
