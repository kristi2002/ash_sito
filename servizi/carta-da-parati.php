...
//  Pagina servizio: Posa di Carta da Parati — PHP + Bootstrap 5
// ============================================================
...
$servizio_titolo = 'Posa di carta da parati';
$servizio_slug   = 'carta-da-parati';
...
$lavorazioni = [
    ['icona' => 'bi-flower1',      'testo' => 'Carte di design'],
    ['icona' => 'bi-image',        'testo' => 'Grafiche personalizzate'],
    ['icona' => 'bi-layers',       'testo' => 'Tessuto non tessuto (TNT)'],
    ['icona' => 'bi-droplet-half', 'testo' => 'Carte viniliche lavabili'],
    ['icona' => 'bi-eraser',       'testo' => 'Rimozione vecchie carte'],
    ['icona' => 'bi-rulers',       'testo' => 'Preparazione dei fondi'],
];

// Perché A.S.H.: la nostra firma sulla posa
$motivi = [
    ['icona' => 'bi-rulers',   'titolo' => 'Posa millimetrica',    'testo' => 'Teli a piombo, disegni allineati e raccordi invisibili'],
    ['icona' => 'bi-layers',   'titolo' => 'Fondi perfetti',       'testo' => 'Pareti rasate e uniformi: la carta rende quanto il supporto'],
    ['icona' => 'bi-scissors', 'titolo' => 'Tagli precisi',        'testo' => 'Rifilature nette su prese, angoli e battiscopa'],
    ['icona' => 'bi-palette',  'titolo' => 'Consulenza di stile',  'testo' => 'Ti aiutiamo a scegliere carta, formato e parete giusta'],
];

// Il ciclo di posa: quattro fasi, dal fondo all'ultimo telo
$fasi_ciclo = [
    ['fase' => '01', 'titolo' => 'Preparazione della parete',  'testo' => 'Rasatura, carteggiatura e primer: la carta da parati esalta ogni difetto, il fondo deve essere liscio e uniforme.'],
    ['fase' => '02', 'titolo' => 'Rilievo e taglio dei teli',  'testo' => 'Misure precise, verifica del rapporto di disegno e taglio dei teli nell\'ordine corretto di posa.'],
    ['fase' => '03', 'titolo' => 'Posa e accostamento',        'testo' => 'Incollaggio e posa a piombo dei teli, con accostamento perfetto del disegno e nessuna bolla d\'aria.'],
    ['fase' => '04', 'titolo' => 'Rifilatura e dettagli',      'testo' => 'Tagli a filo di soffitti, angoli e cornici e pulizia dei giunti: raccordi invisibili anche da vicino.', 'firma' => true],
];

// Dove interveniamo: contesti tipici, raccontati come card premium con foto della tipologia
$applicazioni = [
    ['icona' => 'bi-house-door',   'titolo' => 'Abitazioni private',     'foto' => '../assets/img/servizi/spazio-abitazioni.jpg',   'testo' => 'Pareti d\'accento in zona giorno e camere da letto: una parete che cambia tutto l\'ambiente.'],
    ['icona' => 'bi-droplet-half', 'titolo' => 'Bagni e cucine',         'foto' => '../assets/img/servizi/spazio-bagni-cucine.jpg', 'testo' => 'Carte viniliche resistenti a umidità e vapore, per ambienti di carattere anche in bagno.'],
    ['icona' => 'bi-briefcase',    'titolo' => 'Uffici e studi',         'foto' => '../assets/img/servizi/spazio-uffici.jpg',       'testo' => 'Reception e sale riunioni con grafiche che raccontano l\'identità dell\'azienda.'],
    ['icona' => 'bi-shop',         'titolo' => 'Negozi e locali',        'foto' => '../assets/img/servizi/spazio-negozi.jpg',       'testo' => 'Pareti scenografiche che valorizzano i prodotti e restano impresse ai clienti.'],
    ['icona' => 'bi-building',     'titolo' => 'Strutture ricettive',    'foto' => '../assets/img/servizi/spazio-facciate.jpg',     'testo' => 'B&B, hotel e agriturismi: camere personalizzate con carte di design e grafiche su misura.'],
    ['icona' => 'bi-door-open',    'titolo' => 'Ingressi e zone comuni', 'foto' => '../assets/img/servizi/spazio-condomini.jpg',    'testo' => 'Ingressi e corridoi più accoglienti, con carte resistenti al passaggio e facili da pulire.'],
];

// FAQ
$faq = [
    [
        'domanda'  => 'Su quali pareti si può posare la carta da parati?',
        'risposta' => 'Su qualsiasi parete liscia, asciutta e ben preparata: intonaco, cartongesso o vecchie pareti rasate a nuovo. La preparazione del fondo è la parte più importante del lavoro: una parete irregolare si vede attraverso qualsiasi carta.',
    ],
    [
        'domanda'  => 'La carta da parati è adatta a bagni e cucine?',
        'risposta' => 'Sì, scegliendo carte viniliche o in fibra di vetro resistenti a umidità e vapore, posate con colle specifiche. In bagno valutiamo caso per caso areazione e distanza dalle fonti d\'acqua, così la carta dura nel tempo.',
    ],
    [
        'domanda'  => 'Quanto dura la carta da parati e come si pulisce?',
        'risposta' => 'Una carta di qualità ben posata dura 10-15 anni e oltre. Le carte viniliche e in TNT si puliscono con un panno umido; per ogni carta ti indichiamo il tipo di manutenzione corretta.',
    ],
    [
        'domanda'  => 'Rimuovete anche la vecchia carta da parati?',
        'risposta' => 'Sì: rimuoviamo la carta esistente, ripristiniamo il fondo con rasature dove serve e prepariamo la parete per la nuova posa o per una tinteggiatura. È un passaggio che consigliamo di non saltare mai.',
    ],
];
...
$json_ld = [
    [
        ...
        '@type'       => 'Service',
        'name'        => 'Posa di Carta da Parati',
        'serviceType' => 'Posa professionale di carta da parati e rivestimenti murali: carte viniliche, TNT e grafiche personalizzate',
        'description' => 'Posa professionale di carta da parati e rivestimenti decorativi con preparazione dei fondi a Camerino (MC) e provincia di Macerata.',
    ...
    [
        ...
        'itemListElement' => [
            ...
            ['@type' => 'ListItem', 'position' => 3, 'name' => 'Carta da Parati'],
        ],
    ],
];
?>
...
<head>
    ...
    <title>Posa di Carta da Parati a Camerino e Macerata | A.S.H. Finiture Contract</title>
    <meta name="description" content="Posa professionale di carta da parati: carte viniliche, TNT, grafiche personalizzate e preparazione dei fondi. Sopralluogo e preventivo gratuiti a Camerino (MC) e provincia.">
                ...
                <div class="col-lg-9">
                    <nav aria-label="Percorso di navigazione" class="fade-up">
                        <ol class="breadcrumb-servizio list-unstyled">
                            ...
                            <li class="separatore" aria-hidden="true"><i class="bi bi-chevron-right"></i></li>
                            <li class="corrente" aria-current="page">Carta da Parati</li>
                        </ol>
                    </nav>
                    <span class="hero-badge fade-up delay-1 mt-3">
                        <i class="bi bi-flower1"></i> Il nostro servizio
                    </span>
                    <h1 class="mt-3 fade-up delay-1">
                        Carta da parati <span class="gold">posata ad arte</span>
                    </h1>
                    <p class="lead mt-3 fade-up delay-2">
                        Precisione millimetrica e raccordi invisibili: pareti uniche e di design che trasformano ogni ambiente.
                    </p>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6 reveal">
                    ...
                    <h2 class="section-title mt-3">Pareti uniche,<br><span class="text-oro">posate al millimetro</span></h2>
                    <div class="title-underline a-sinistra"></div>
                    <p class="mt-4">
                        Trasformiamo le tue pareti con <strong>carte da parati e rivestimenti di design</strong>:
                        fondi preparati con cura, <strong>posa millimetrica</strong> e raccordi
                        invisibili. Ogni progetto parte da un sopralluogo gratuito con consulenza
                        sulla scelta della carta.
                    </p>
                ...
                <div class="col-lg-6 reveal" style="transition-delay:.15s">
                    <div class="composizione-foto">
                        <img class="foto-principale"
                             src="<?php echo $foto_cantiere_url[7] ?? '../assets/img/card-servizio-bg.jpg'; ?>"
                             alt="Parete decorata con carta da parati posata da A.S.H. Finiture Contract"
                             loading="lazy">
                        <?php if (isset($foto_cantiere_url[8])): ?>
                        <img class="foto-secondaria"
                             src="<?php echo $foto_cantiere_url[8]; ?>"
                             alt="Dettaglio di una posa di rivestimento murale in un cantiere A.S.H."
                             loading="lazy">
                        <?php endif; ?>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6 reveal">
                    <div class="mini-mosaico-wrap">
                        ...
                        <div class="mini-mosaico">
                            <?php foreach (array_slice($foto_cantiere_url, 9, 4) as $i => $src): ?>
                            <figure>
                                <img src="<?php echo $src; ?>"
                                     alt="Rivestimento murale realizzato da A.S.H. Finiture Contract"
                                     loading="lazy">
                            </figure>
                            <?php endforeach; ?>
                        </div>
                ...
                <div class="col-lg-6 reveal" style="transition-delay:.15s">
                    ...
                    <h2 class="section-title mt-3">La nostra firma,<br><span class="text-oro">in ogni telo</span></h2>
                    <div class="title-underline a-sinistra"></div>
                    <p class="mt-4">
    ...
    <section id="ciclo">
        ...
        <div class="container">
            <div class="text-center mb-5 reveal">
                ...
                <h2 class="section-title mt-3">La nostra posa <span class="text-oro">in 4 fasi</span></h2>
                <div class="title-underline"></div>
                <p class="mt-3 mx-auto" style="max-width: 660px;">
                    La posa è solo l'ultimo passaggio: il risultato si costruisce prima.
                    Ogni parete segue un ciclo preciso in quattro fasi &mdash;
                    ed è nella rifilatura finale che si vede la differenza.
                </p>
            </div>
            <div class="row g-4 pt-2 align-items-stretch">
                <div class="col-lg-5 reveal">
                    <div class="foto-ciclo">
                        <img src="<?php echo $foto_cantiere_url[13] ?? '../assets/img/servizi/spazio-abitazioni.jpg'; ?>"
                             alt="Preparazione di una parete per la posa della carta da parati in un cantiere A.S.H."
                             loading="lazy">
                        <div class="velo" aria-hidden="true"></div>
                        <span class="badge-qualita">
                            <i class="bi bi-flower1" aria-hidden="true"></i> La posa in cantiere
                        </span>
                        <div class="didascalia">
                            <h5>Telo dopo telo</h5>
                            <p>Dal fondo rasato all'ultima rifilatura: una parete perfetta nasce da una posa rispettata.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
    ...
    <section id="applicazioni">
        <div class="container">
            <div class="text-center mb-5 reveal">
                ...
                <h2 class="section-title mt-3">Ogni ambiente, <span class="text-oro">la sua carta</span></h2>
                <div class="title-underline"></div>
                <p class="mt-3 mx-auto" style="max-width: 640px;">
                    Dalla parete della camera alla sala riunioni: questi sono i contesti
                    in cui la carta da parati dà più carattere.
                </p>
            </div>
            <div class="row g-4">
                    ...
                    <div class="card-applicazione">
                        <div class="foto-applicazione">
                            <img src="<?php echo $applicazione['foto']; ?>"
                                 alt="<?php echo $applicazione['titolo']; ?> — posa carta da parati A.S.H. Finiture Contract"
                                 loading="lazy">
                        </div>
        ...
        <div class="container">
            <div class="row align-items-center g-4">
                <div class="col-lg-7 reveal">
                    <h2 class="mb-2">Hai una parete da trasformare?</h2>
                    <p class="fs-5 mb-4" style="color:rgba(255,255,255,.9)">
                        <em>"<?php echo $tagline; ?>"</em> — richiedi subito un
                        <strong>preventivo gratuito</strong> e senza impegno per la tua carta da parati.
                    </p>
    ...
    <section id="faq">
        <div class="container">
            <div class="text-center mb-5 reveal">
                ...
                <h2 class="section-title mt-3">FAQ sulla Carta da Parati</h2>
                <div class="title-underline"></div>
            </div>
