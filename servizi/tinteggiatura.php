...
//  Pagina servizio: Tinteggiature Interne ed Esterne — PHP + Bootstrap 5
// ============================================================
...
$servizio_titolo = 'Tinteggiature interne ed esterne';
$servizio_slug   = 'tinteggiatura';
...
$lavorazioni = [
    ['icona' => 'bi-house',        'testo' => 'Tinteggiature interne'],
    ['icona' => 'bi-building',     'testo' => 'Facciate esterne'],
    ['icona' => 'bi-droplet-half', 'testo' => 'Pitture lavabili'],
    ['icona' => 'bi-wind',         'testo' => 'Traspiranti e antimuffa'],
    ['icona' => 'bi-palette',      'testo' => 'Consulenza colore'],
    ['icona' => 'bi-magic',        'testo' => 'Effetti decorativi'],
];

// Perché A.S.H.: la nostra firma sul colore
$motivi = [
    ['icona' => 'bi-brush',        'titolo' => 'Mano esperta',          'testo' => 'Stesure uniformi, senza aloni né riprese visibili'],
    ['icona' => 'bi-droplet',      'titolo' => 'Prodotti selezionati',  'testo' => 'Pitture professionali, scelte ambiente per ambiente'],
    ['icona' => 'bi-shield-check', 'titolo' => 'Protezione totale',     'testo' => 'Teli, nastri e coperture: la casa resta pulita'],
    ['icona' => 'bi-stopwatch',    'titolo' => 'Tempi certi',           'testo' => 'Inizio e consegna concordati e rispettati'],
];

// Il ciclo di tinteggiatura: quattro fasi, dalla preparazione alla finitura
$fasi_ciclo = [
    ['fase' => '01', 'titolo' => 'Preparazione dei fondi', 'testo' => 'Stuccatura di crepe e fori, carteggiatura e spolveratura: nessuna pittura rende su un supporto mal preparato.'],
    ['fase' => '02', 'titolo' => 'Fissativo di fondo',     'testo' => 'Primer ancorante che uniforma l\'assorbimento della parete e fa aderire la pittura in modo omogeneo e duraturo.'],
    ['fase' => '03', 'titolo' => 'Prima mano',             'testo' => 'Stesura uniforme a rullo e pennello, con controllo costante di spessori, riprese e tempi di asciugatura.'],
    ['fase' => '04', 'titolo' => 'Seconda mano e dettagli','testo' => 'Mano finale incrociata e rifinitura di angoli, spigoli e tagli a filo soffitto: colore pieno e uniforme anche in luce radente.', 'firma' => true],
];

// Dove interveniamo: contesti tipici, raccontati come card premium con foto della tipologia
$applicazioni = [
    ['icona' => 'bi-house-door',   'titolo' => 'Abitazioni private',    'foto' => '../assets/img/servizi/spazio-abitazioni.jpg',   'testo' => 'Rinnovo completo di appartamenti e case: pareti, soffitti e ritocchi curati stanza per stanza.'],
    ['icona' => 'bi-building',     'titolo' => 'Facciate ed esterni',   'foto' => '../assets/img/servizi/spazio-facciate.jpg',     'testo' => 'Pitture al quarzo e silossaniche che proteggono la facciata da pioggia, sole e smog.'],
    ['icona' => 'bi-droplet-half', 'titolo' => 'Bagni e cucine',        'foto' => '../assets/img/servizi/spazio-bagni-cucine.jpg', 'testo' => 'Pitture antimuffa e anticondensa specifiche per gli ambienti più umidi della casa.'],
    ['icona' => 'bi-briefcase',    'titolo' => 'Uffici e studi',        'foto' => '../assets/img/servizi/spazio-uffici.jpg',       'testo' => 'Colori neutri e pitture lavabili per spazi di lavoro ordinati e rappresentativi.'],
    ['icona' => 'bi-shop',         'titolo' => 'Negozi e locali',       'foto' => '../assets/img/servizi/spazio-negozi.jpg',       'testo' => 'Tinteggiature rapide, anche in orari di chiusura, per non fermare la tua attività.'],
    ['icona' => 'bi-buildings',    'titolo' => 'Vani scala e condomini','foto' => '../assets/img/servizi/spazio-condomini.jpg',    'testo' => 'Parti comuni tinteggiate con pitture resistenti al passaggio e facili da ritoccare.'],
];

// FAQ
$faq = [
    [
        'domanda'  => 'Quanto tempo serve per tinteggiare un appartamento?',
        'risposta' => 'Un appartamento di media grandezza (80-100 mq) richiede in genere 3-5 giorni lavorativi, comprese la preparazione dei fondi e due mani di pittura. I tempi esatti dipendono dallo stato delle pareti e dai colori scelti: li indichiamo sempre nel preventivo.',
    ],
    [
        'domanda'  => 'Meglio una pittura lavabile o una traspirante?',
        'risposta' => 'Dipende dall\'ambiente. La lavabile è ideale per zone giorno, corridoi e camerette, perché si pulisce facilmente; la traspirante è perfetta per bagni e cucine, perché lascia respirare la parete e contrasta la condensa. Durante il sopralluogo ti consigliamo il prodotto giusto stanza per stanza.',
    ],
    [
        'domanda'  => 'Devo svuotare le stanze prima della tinteggiatura?',
        'risposta' => 'No. Basta liberare le pareti: spostiamo i mobili al centro della stanza e proteggiamo pavimenti e superfici con teli e nastri. A fine lavoro riposizioniamo tutto e riconsegniamo gli ambienti puliti.',
    ],
    [
        'domanda'  => 'Come trattate la muffa prima di tinteggiare?',
        'risposta' => 'Prima igienizziamo la parete con un trattamento antimuffa specifico, poi applichiamo un fondo risanante e infine una pittura traspirante anticondensa. Coprire la muffa con la sola pittura la farebbe ricomparire in poche settimane.',
    ],
];
...
$json_ld = [
    [
        ...
        '@type'       => 'Service',
        'name'        => 'Tinteggiature Interne ed Esterne',
        'serviceType' => 'Tinteggiature interne ed esterne: pitture lavabili, traspiranti, antimuffa e finiture decorative',
        'description' => 'Tinteggiature interne ed esterne con pitture lavabili, traspiranti e antimuffa a Camerino (MC) e provincia di Macerata.',
    ...
    [
        ...
        'itemListElement' => [
            ...
            ['@type' => 'ListItem', 'position' => 3, 'name' => 'Tinteggiatura'],
        ],
    ],
];
?>
...
<head>
    ...
    <title>Tinteggiature Interne ed Esterne a Camerino e Macerata | A.S.H. Finiture Contract</title>
    <meta name="description" content="Tinteggiature interne ed esterne, pitture lavabili, traspiranti e antimuffa, finiture decorative. Sopralluogo e preventivo gratuiti a Camerino (MC) e provincia.">
                ...
                <div class="col-lg-9">
                    <nav aria-label="Percorso di navigazione" class="fade-up">
                        <ol class="breadcrumb-servizio list-unstyled">
                            ...
                            <li class="separatore" aria-hidden="true"><i class="bi bi-chevron-right"></i></li>
                            <li class="corrente" aria-current="page">Tinteggiatura</li>
                        </ol>
                    </nav>
                    <span class="hero-badge fade-up delay-1 mt-3">
                        <i class="bi bi-paint-bucket"></i> Il nostro servizio
                    </span>
                    <h1 class="mt-3 fade-up delay-1">
                        Tinteggiature <span class="gold">interne ed esterne</span>
                    </h1>
                    <p class="lead mt-3 fade-up delay-2">
                        Colori a regola d'arte che rinnovano gli ambienti e proteggono le superfici, dentro e fuori casa.
                    </p>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6 reveal">
                    ...
                    <h2 class="section-title mt-3">Il colore giusto,<br><span class="text-oro">steso a regola d'arte</span></h2>
                    <div class="title-underline a-sinistra"></div>
                    <p class="mt-4">
                        Rinnoviamo i tuoi ambienti con <strong>fondi preparati con cura</strong>,
                        prodotti professionali e <strong>stesure uniformi</strong>, senza aloni
                        né riprese. Ogni progetto parte da un sopralluogo gratuito con consiglio colore.
                    </p>
                ...
                <div class="col-lg-6 reveal" style="transition-delay:.15s">
                    <div class="composizione-foto">
                        <img class="foto-principale"
                             src="<?php echo $foto_cantiere_url[6] ?? '../assets/img/card-servizio-bg.jpg'; ?>"
                             alt="Ambiente tinteggiato di fresco da A.S.H. Finiture Contract"
                             loading="lazy">
                        <?php if (isset($foto_cantiere_url[7])): ?>
                        <img class="foto-secondaria"
                             src="<?php echo $foto_cantiere_url[7]; ?>"
                             alt="Dettaglio di una finitura a pittura in un cantiere A.S.H."
                             loading="lazy">
                        <?php endif; ?>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6 reveal">
                    <div class="mini-mosaico-wrap">
                        ...
                        <div class="mini-mosaico">
                            <?php foreach (array_slice($foto_cantiere_url, 8, 4) as $i => $src): ?>
                            <figure>
                                <img src="<?php echo $src; ?>"
                                     alt="Tinteggiatura realizzata da A.S.H. Finiture Contract"
                                     loading="lazy">
                            </figure>
                            <?php endforeach; ?>
                        </div>
                ...
                <div class="col-lg-6 reveal" style="transition-delay:.15s">
                    ...
                    <h2 class="section-title mt-3">La nostra firma,<br><span class="text-oro">in ogni pennellata</span></h2>
                    <div class="title-underline a-sinistra"></div>
                    <p class="mt-4">
        ...
        <div class="container">
            <div class="text-center mb-5 reveal">
                ...
                <p class="mt-3 mx-auto" style="max-width: 660px;">
                    Il colore è solo l'ultimo passaggio: il risultato si costruisce prima.
                    Ogni tinteggiatura segue un ciclo preciso in quattro fasi &mdash;
                    ed è nei dettagli dell'ultima mano che si vede la differenza.
                </p>
            </div>
            <div class="row g-4 pt-2 align-items-stretch">
                <div class="col-lg-5 reveal">
                    <div class="foto-ciclo">
                        <img src="../assets/img/servizi/tinteggiatura-ciclo.jpg"
                             alt="Rullo che stende la pittura sulla parete durante il ciclo di tinteggiatura"
                             loading="lazy">
                        <div class="velo" aria-hidden="true"></div>
                        <span class="badge-qualita">
                            <i class="bi bi-paint-bucket" aria-hidden="true"></i> Il ciclo in cantiere
                        </span>
                        <div class="didascalia">
                            <h5>Mano dopo mano</h5>
                            <p>Dalla preparazione dei fondi all'ultima mano incrociata: il colore pieno nasce da un ciclo rispettato.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
    ...
    <section id="applicazioni">
        <div class="container">
            <div class="text-center mb-5 reveal">
                ...
                <h2 class="section-title mt-3">Ogni spazio, <span class="text-oro">il suo colore</span></h2>
                <div class="title-underline"></div>
                <p class="mt-3 mx-auto" style="max-width: 640px;">
                    Dalla singola stanza alla facciata condominiale: questi sono i contesti
                    in cui portiamo più spesso colore e protezione.
                </p>
            </div>
            <div class="row g-4">
                    ...
                    <div class="card-applicazione">
                        <div class="foto-applicazione">
                            <img src="<?php echo $applicazione['foto']; ?>"
                                 alt="<?php echo $applicazione['titolo']; ?> — tinteggiature A.S.H. Finiture Contract"
                                 loading="lazy">
                        </div>
        ...
        <div class="container">
            <div class="row align-items-center g-4">
                <div class="col-lg-7 reveal">
                    <h2 class="mb-2">Hai un progetto di tinteggiatura?</h2>
                    <p class="fs-5 mb-4" style="color:rgba(255,255,255,.9)">
                        <em>"<?php echo $tagline; ?>"</em> — richiedi subito un
                        <strong>preventivo gratuito</strong> e senza impegno per le tue tinteggiature.
                    </p>
    ...
    <section id="faq">
        <div class="container">
            <div class="text-center mb-5 reveal">
                ...
                <h2 class="section-title mt-3">FAQ sulla Tinteggiatura</h2>
                <div class="title-underline"></div>
            </div>
