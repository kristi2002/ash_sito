...
//  Pagina servizio: Rasatura Armata — PHP + Bootstrap 5
// ============================================================
...
$servizio_titolo = 'Rasatura armata';
$servizio_slug   = 'rasatura-armata';
...
$lavorazioni = [
    ['icona' => 'bi-shield-check', 'testo' => 'Rasatura su cappotto'],
    ['icona' => 'bi-grid-3x3',     'testo' => 'Rete in fibra di vetro'],
    ['icona' => 'bi-building',     'testo' => 'Ripristino facciate'],
    ['icona' => 'bi-bandaid',      'testo' => 'Supporti fessurati'],
    ['icona' => 'bi-layers-half',  'testo' => 'Fondi critici e misti'],
    ['icona' => 'bi-brush',        'testo' => 'Finitura liscia o civile'],
];

// Perché A.S.H.: la nostra firma sulla rasatura armata
$motivi = [
    ['icona' => 'bi-shield-check',    'titolo' => 'Barriera anti-crepe',  'testo' => 'La rete annegata assorbe i movimenti del supporto'],
    ['icona' => 'bi-bullseye',        'titolo' => 'Superfici uniformi',   'testo' => 'Planarità e assorbimento omogeneo su tutta la parete'],
    ['icona' => 'bi-droplet',         'titolo' => 'Malte selezionate',    'testo' => 'Rasanti certificati, scelti in base al supporto'],
    ['icona' => 'bi-hourglass-split', 'titolo' => 'Durata nel tempo',     'testo' => 'Una base solida che protegge la finitura per anni'],
];

// Il ciclo di rasatura armata: quattro fasi, dal supporto alla finitura
$fasi_ciclo = [
    ['fase' => '01', 'titolo' => 'Analisi del supporto',   'testo' => 'Verifica di crepe, distacchi e assorbimento: la rasatura armata rende solo su un fondo valutato con cura.'],
    ['fase' => '02', 'titolo' => 'Preparazione e primer',  'testo' => 'Pulizia, consolidamento delle parti deboli e primer di aggancio per un\'adesione perfetta della malta rasante.'],
    ['fase' => '03', 'titolo' => 'Prima rasata e rete',    'testo' => 'Stesura del rasante e annegatura della rete in fibra di vetro con i giusti sormonti: è l\'armatura che blocca le crepe.'],
    ['fase' => '04', 'titolo' => 'Rasata di finitura',     'testo' => 'Seconda passata a coprire la rete e lisciatura finale: superficie uniforme, pronta per pittura o intonachino.', 'firma' => true],
];

// Dove interveniamo: contesti tipici, raccontati come card premium con foto della tipologia
$applicazioni = [
    ['icona' => 'bi-building',     'titolo' => 'Facciate e cappotti',   'foto' => '../assets/img/servizi/spazio-facciate.jpg',     'testo' => 'Rasature armate su cappotto e facciate esistenti: la base giusta prima della finitura colorata.'],
    ['icona' => 'bi-house-door',   'titolo' => 'Abitazioni private',    'foto' => '../assets/img/servizi/spazio-abitazioni.jpg',   'testo' => 'Pareti interne fessurate o irregolari riportate a nuovo, pronte per la tinteggiatura.'],
    ['icona' => 'bi-buildings',    'titolo' => 'Vani scala e condomini','foto' => '../assets/img/servizi/spazio-condomini.jpg',    'testo' => 'Ripristino di parti comuni segnate dal tempo, con superfici solide e uniformi.'],
    ['icona' => 'bi-briefcase',    'titolo' => 'Uffici e studi',        'foto' => '../assets/img/servizi/spazio-uffici.jpg',       'testo' => 'Superfici piane e senza difetti per ambienti di lavoro curati e rappresentativi.'],
    ['icona' => 'bi-shop',         'titolo' => 'Negozi e locali',       'foto' => '../assets/img/servizi/spazio-negozi.jpg',       'testo' => 'Pareti rimesse a nuovo in tempi rapidi, anche in orari di chiusura dell\'attività.'],
    ['icona' => 'bi-droplet-half', 'titolo' => 'Bagni e cucine',        'foto' => '../assets/img/servizi/spazio-bagni-cucine.jpg', 'testo' => 'Rasanti specifici per ambienti umidi, come base per pitture traspiranti e rivestimenti.'],
];

// FAQ
$faq = [
    [
        'domanda'  => 'Cos\'è la rasatura armata e quando serve?',
        'risposta' => 'È una rasatura in cui viene annegata una rete in fibra di vetro tra due passate di malta. Serve quando il supporto è fessurato, misto o critico — cappotti, intonaci vecchi, pareti con crepe — perché la rete distribuisce le tensioni ed evita che le fessure ricompaiano in superficie.',
    ],
    [
        'domanda'  => 'La rasatura armata elimina le crepe per sempre?',
        'risposta' => 'Le crepe superficiali da assestamento sì: la rete le assorbe e ne impedisce la ricomparsa. Se le lesioni sono strutturali va prima risolta la causa: durante il sopralluogo distinguiamo i due casi e ti proponiamo la soluzione corretta.',
    ],
    [
        'domanda'  => 'Si può rasare sopra un cappotto esistente?',
        'risposta' => 'Sì, è uno degli interventi più richiesti: dopo la verifica dell\'aggancio dei pannelli, applichiamo un ciclo di rasatura armata che rigenera il cappotto e lo prepara alla nuova finitura, senza doverlo rifare da zero.',
    ],
    [
        'domanda'  => 'Che finitura si può applicare dopo la rasatura armata?',
        'risposta' => 'Praticamente tutte: pittura, intonachino o rivestimenti colorati. La rasatura armata è la base ideale perché uniforma planarità e assorbimento del supporto; ti consigliamo la finitura più adatta all\'ambiente e all\'esposizione.',
    ],
];
...
$json_ld = [
    [
        ...
        '@type'       => 'Service',
        'name'        => 'Rasatura Armata',
        'serviceType' => 'Rasatura armata con rete in fibra di vetro su cappotti, facciate e supporti critici',
        'description' => 'Rasature armate con rete in fibra di vetro per superfici solide e senza crepe, su cappotti e facciate, a Camerino (MC) e provincia di Macerata.',
    ...
    [
        ...
        'itemListElement' => [
            ...
            ['@type' => 'ListItem', 'position' => 3, 'name' => 'Rasatura Armata'],
        ],
    ],
];
?>
...
<head>
    ...
    <title>Rasatura Armata a Camerino e Macerata | A.S.H. Finiture Contract</title>
    <meta name="description" content="Rasatura armata con rete in fibra di vetro: superfici uniformi e resistenti alle crepe, ideale su cappotti e supporti critici. Sopralluogo e preventivo gratuiti a Camerino (MC) e provincia.">
...
<body>
                ...
                <div class="col-lg-9">
                    <nav aria-label="Percorso di navigazione" class="fade-up">
                        <ol class="breadcrumb-servizio list-unstyled">
                            ...
                            <li class="separatore" aria-hidden="true"><i class="bi bi-chevron-right"></i></li>
                            <li class="corrente" aria-current="page">Rasatura Armata</li>
                        </ol>
                    </nav>
                    <span class="hero-badge fade-up delay-1 mt-3">
                        <i class="bi bi-shield-check"></i> Il nostro servizio
                    </span>
                    <h1 class="mt-3 fade-up delay-1">
                        Rasatura <span class="gold">armata</span>
                    </h1>
                    <p class="lead mt-3 fade-up delay-2">
                        Superfici solide, piane e senza crepe: la base che fa durare ogni finitura, su cappotti, facciate e pareti interne.
                    </p>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6 reveal">
                    ...
                    <h2 class="section-title mt-3">Una base solida,<br><span class="text-oro">per ogni finitura</span></h2>
                    <div class="title-underline a-sinistra"></div>
                    <p class="mt-4">
                        Rigeneriamo pareti e facciate con <strong>rasature rinforzate con rete in fibra di vetro</strong>:
                        superfici uniformi, resistenti alle crepe e <strong>pronte per qualsiasi finitura</strong>.
                        Ogni progetto parte da un sopralluogo gratuito con analisi del supporto.
                    </p>
                ...
                <div class="col-lg-6 reveal" style="transition-delay:.15s">
                    <div class="composizione-foto">
                        <img class="foto-principale"
                             src="<?php echo $foto_cantiere_url[19] ?? '../assets/img/card-servizio-bg.jpg'; ?>"
                             alt="Parete rigenerata con rasatura armata da A.S.H. Finiture Contract"
                             loading="lazy">
                        <?php if (isset($foto_cantiere_url[20])): ?>
                        <img class="foto-secondaria"
                             src="<?php echo $foto_cantiere_url[20]; ?>"
                             alt="Dettaglio di una rasatura armata in un cantiere A.S.H."
                             loading="lazy">
                        <?php endif; ?>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6 reveal">
                    <div class="mini-mosaico-wrap">
                        ...
                        <div class="mini-mosaico">
                            <?php foreach (array_slice($foto_cantiere_url, 21, 4) as $i => $src): ?>
                            <figure>
                                <img src="<?php echo $src; ?>"
                                     alt="Rasatura armata realizzata da A.S.H. Finiture Contract"
                                     loading="lazy">
                            </figure>
                            <?php endforeach; ?>
                        </div>
                ...
                <div class="col-lg-6 reveal" style="transition-delay:.15s">
                    ...
                    <h2 class="section-title mt-3">La nostra firma,<br><span class="text-oro">sotto ogni finitura</span></h2>
                    <div class="title-underline a-sinistra"></div>
                    <p class="mt-4">
    ...
    <!-- ================= IL CICLO DI RASATURA ARMATA IN 4 FASI ================= -->
    <section id="ciclo">
        <div class="bagliore" aria-hidden="true"></div>
        <div class="container">
            <div class="text-center mb-5 reveal">
                <span class="hero-badge"><i class="bi bi-gem"></i> Metodo professionale</span>
                <h2 class="section-title mt-3">Il nostro ciclo <span class="text-oro">in 4 fasi</span></h2>
                <div class="title-underline"></div>
                <p class="mt-3 mx-auto" style="max-width: 660px;">
                    La finitura è solo ciò che si vede: la durata si costruisce sotto.
                    Ogni rasatura armata segue un ciclo preciso in quattro fasi &mdash;
                    ed è nella rasata finale che si vede la differenza.
                </p>
            </div>
            <div class="row g-4 pt-2 align-items-stretch">
                <div class="col-lg-5 reveal">
                    <div class="foto-ciclo">
                        <img src="<?php echo $foto_cantiere_url[25] ?? '../assets/img/servizi/spazio-facciate.jpg'; ?>"
                             alt="Applicazione della rasatura armata in un cantiere A.S.H."
                             loading="lazy">
                        <div class="velo" aria-hidden="true"></div>
                        <span class="badge-qualita">
                            <i class="bi bi-shield-check" aria-hidden="true"></i> Il ciclo in cantiere
                        </span>
                        <div class="didascalia">
                            <h5>Passata dopo passata</h5>
                            <p>Dall'analisi del supporto alla lisciatura finale: una superficie senza crepe nasce da un ciclo rispettato.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
    ...
    <section id="applicazioni">
        <div class="container">
            <div class="text-center mb-5 reveal">
                ...
                <h2 class="section-title mt-3">Ogni supporto, <span class="text-oro">la sua rasatura</span></h2>
                <div class="title-underline"></div>
                <p class="mt-3 mx-auto" style="max-width: 640px;">
                    Dal cappotto di casa alla facciata condominiale: questi sono i contesti
                    in cui la rasatura armata fa la differenza.
                </p>
            </div>
            <div class="row g-4">
                    ...
                    <div class="card-applicazione">
                        <div class="foto-applicazione">
                            <img src="<?php echo $applicazione['foto']; ?>"
                                 alt="<?php echo $applicazione['titolo']; ?> — rasatura armata A.S.H. Finiture Contract"
                                 loading="lazy">
                        </div>
        ...
        <div class="container">
            <div class="row align-items-center g-4">
                <div class="col-lg-7 reveal">
                    <h2 class="mb-2">Hai pareti o facciate da rigenerare?</h2>
                    <p class="fs-5 mb-4" style="color:rgba(255,255,255,.9)">
                        <em>"<?php echo $tagline; ?>"</em> — richiedi subito un
                        <strong>preventivo gratuito</strong> e senza impegno per la tua rasatura armata.
                    </p>
    ...
    <section id="faq">
        <div class="container">
            <div class="text-center mb-5 reveal">
                ...
                <h2 class="section-title mt-3">FAQ sulla Rasatura Armata</h2>
                <div class="title-underline"></div>
            </div>
