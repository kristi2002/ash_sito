...
//  Pagina servizio: Opere in Cartongesso — PHP + Bootstrap 5
// ============================================================
...
$servizio_titolo = 'Opere in cartongesso';
$servizio_slug   = 'cartongesso';
...
$lavorazioni = [
    ['icona' => 'bi-grid-1x2',        'testo' => 'Pareti divisorie'],
    ['icona' => 'bi-border-bottom',   'testo' => 'Controsoffitti'],
    ['icona' => 'bi-thermometer-snow','testo' => 'Contropareti isolanti'],
    ['icona' => 'bi-lightbulb',       'testo' => 'Velette per LED'],
    ['icona' => 'bi-bookshelf',       'testo' => 'Nicchie e librerie'],
    ['icona' => 'bi-box-seam',        'testo' => 'Mobili su misura'],
];

// Perché A.S.H.: la nostra firma sul cartongesso
$motivi = [
    ['icona' => 'bi-hammer',          'titolo' => 'Specialisti veri',        'testo' => 'Cartongesso ogni giorno, in ogni cantiere'],
    ['icona' => 'bi-bullseye',        'titolo' => 'Precisione millimetrica', 'testo' => 'Superfici lisce, pronte per la finitura'],
    ['icona' => 'bi-stopwatch',       'titolo' => 'Consegne puntuali',       'testo' => 'Cantiere ordinato, tempi rispettati'],
    ['icona' => 'bi-patch-check',     'titolo' => 'Materiali certificati',   'testo' => 'Un unico referente, dal primo giorno'],
];

// Livelli di finitura della stuccatura (standard europeo Q1-Q4)
$livelli_finitura = [
    ['livello' => 'Q1', 'titolo' => 'Stuccatura di base',  'testo' => 'Giunti e viti stuccati: la base tecnica ideale per piastrelle e rivestimenti.'],
    ['livello' => 'Q2', 'titolo' => 'Finitura standard',   'testo' => 'Seconda passata e carteggiatura: pronta per pitture strutturate e rivestimenti spessi.'],
    ['livello' => 'Q3', 'titolo' => 'Finitura avanzata',   'testo' => 'Rasatura estesa dei giunti: superficie uniforme per pitture opache e finiture fini.'],
    ['livello' => 'Q4', 'titolo' => 'Rasatura totale',     'testo' => 'Rasatura dell\'intera superficie: impeccabile anche con luce radente, smalti e finiture di pregio.', 'firma' => true],
];
...
$faq = [
    [
        'domanda'  => 'Si possono appendere pensili, mensole o TV su una parete in cartongesso?',
        'risposta' => 'Sì. Con tasselli specifici e, per i carichi maggiori, rinforzi interni predisposti in fase di montaggio, il cartongesso sostiene senza problemi pensili, mensole e TV. Basta segnalarci in anticipo dove serviranno.',
    ],
    [
        'domanda'  => 'Il cartongesso isola dal rumore?',
        'risposta' => 'Una parete o controparete in cartongesso con lana minerale nell\'intercapedine migliora sensibilmente l\'isolamento acustico rispetto a una parete tradizionale non isolata. Le stratigrafie si scelgono in base al risultato desiderato.',
    ],
    [
        'domanda'  => 'Quanto tempo richiede una parete in cartongesso?',
        'risposta' => 'Una parete divisoria standard si realizza in genere in 1-2 giorni di lavoro, stuccatura compresa. I tempi esatti dipendono da dimensioni, impianti e finiture: li indichiamo sempre nel preventivo.',
    ],
    [
        'domanda'  => 'Il cartongesso è adatto ai bagni?',
        'risposta' => 'Sì, utilizzando lastre idrorepellenti specifiche per ambienti umidi, idonee anche come supporto per i rivestimenti.',
    ],
];
...
$json_ld = [
    [
        ...
        '@type'       => 'Service',
        'name'        => 'Opere in Cartongesso',
        'serviceType' => 'Opere in cartongesso: pareti divisorie, controsoffitti, contropareti isolanti e arredi su misura',
        'description' => 'Pareti divisorie, controsoffitti, contropareti isolanti e arredi su misura in cartongesso a Camerino (MC) e provincia di Macerata.',
    ...
    [
        ...
        'itemListElement' => [
            ...
            ['@type' => 'ListItem', 'position' => 3, 'name' => 'Cartongesso'],
        ],
    ],
];
?>
...
<head>
    ...
    <title>Opere in Cartongesso a Camerino e Macerata | A.S.H. Finiture Contract</title>
    <meta name="description" content="Pareti divisorie, controsoffitti, contropareti isolanti e arredi su misura in cartongesso. Sopralluogo e preventivo gratuiti a Camerino (MC) e provincia.">
    ...
    <style>
        ...
        * { scroll-margin-top: 84px; }
        ...
        /* Sigla del livello in oro sfumato */
        .card-finitura .livello {
            font-size: 2.1rem;
            font-weight: 800;
            line-height: 1;
            margin-bottom: .8rem;
        ...
        /* Barra di livello: cresce da Q1 a Q4 */
        .card-finitura .barra-livello {
            margin-top: auto;
            height: 4px;
            border-radius: 2px;
        ...
        .card-finitura .barra-livello span {
            display: block;
            height: 100%;
            border-radius: 2px;
        ...
        /* Q4: la card firma, con badge e bordo oro pieno */
        .card-finitura.firma {
        ...
        /* Banner fotografico del metodo: la stuccatura vista da vicino */
        .banner-metodo {
            position: relative;
            margin-top: 2.8rem;
            border-radius: 22px;
        ...
        .banner-metodo .velo {
            position: absolute;
            inset: 0;
            background: linear-gradient(180deg, transparent 35%, rgba(24, 30, 34, .78) 100%);
        }

        .banner-metodo .badge-qualita { top: 18px; right: 18px; }

        .banner-metodo .didascalia {
            position: absolute;
            left: 1.6rem;
            right: 1.6rem;
            bottom: 1.3rem;
        ...
        @media (max-width: 767.98px) {
            .banner-metodo img { aspect-ratio: 4 / 3; }
        }
        ...
        @media (max-width: 575.98px) {
            ...
            #finiture, #applicazioni, #faq { padding: 3.8rem 0; }
                ...
                <div class="col-lg-9">
                    <nav aria-label="Percorso di navigazione" class="fade-up">
                        <ol class="breadcrumb-servizio list-unstyled">
                            ...
                            <li class="separatore" aria-hidden="true"><i class="bi bi-chevron-right"></i></li>
                            <li class="corrente" aria-current="page">Cartongesso</li>
                        </ol>
                    </nav>
                    <span class="hero-badge fade-up delay-1 mt-3">
                        <i class="bi bi-bricks"></i> Il nostro servizio
                    </span>
                    <h1 class="mt-3 fade-up delay-1">
                        Opere in <span class="gold">cartongesso</span>
                    </h1>
                    <p class="lead mt-3 fade-up delay-2">
                        Pareti, controsoffitti e soluzioni su misura per trasformare i tuoi spazi.
                    </p>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6 reveal">
                    ...
                    <h2 class="section-title mt-3">Soluzioni su misura,<br><span class="text-oro">cantieri puliti</span></h2>
                    <div class="title-underline a-sinistra"></div>
                    <p class="mt-4">
                        Ridefiniamo i tuoi ambienti in <strong>tempi rapidi</strong>, con cantieri puliti
                        e <strong>senza opere murarie invasive</strong>. Ogni progetto parte da un
                ...
                <div class="col-lg-6 reveal" style="transition-delay:.15s">
                    <div class="composizione-foto">
                        <img class="foto-principale"
                             src="<?php echo $foto_cantiere_url[0] ?? '../assets/img/card-servizio-bg.jpg'; ?>"
                             alt="Controsoffitto in cartongesso realizzato da A.S.H. Finiture Contract"
                             loading="lazy">
                        <?php if (isset($foto_cantiere_url[1])): ?>
                        <img class="foto-secondaria"
                             src="<?php echo $foto_cantiere_url[1]; ?>"
                             alt="Dettaglio di una parete in cartongesso in un cantiere A.S.H."
                             loading="lazy">
                        <?php endif; ?>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                        ...
                        <div class="mini-mosaico">
                            ...
                            <figure>
                                <img src="<?php echo $src; ?>"
                                     alt="Opera in cartongesso realizzata da A.S.H. Finiture Contract"
                                     loading="lazy">
                            </figure>
                            <?php endforeach; ?>
                        </div>
                ...
                <div class="col-lg-6 reveal" style="transition-delay:.15s">
                    ...
                    <h2 class="section-title mt-3">La nostra firma,<br><span class="text-oro">su ogni parete</span></h2>
                    <div class="title-underline a-sinistra"></div>
                    <p class="mt-4">
    ...
    <section id="finiture">
        ...
        <div class="container">
            <div class="text-center mb-5 reveal">
                <span class="hero-badge"><i class="bi bi-gem"></i> Qualità misurabile</span>
                <h2 class="section-title mt-3">Livelli di finitura <span class="text-oro">Q1&ndash;Q4</span></h2>
                <div class="title-underline"></div>
                <p class="mt-3 mx-auto" style="max-width: 660px;">
                    La qualità della stuccatura si misura: lo standard europeo la classifica
                    da Q1 a Q4. Ti consigliamo il livello giusto per ogni superficie &mdash;
                    e dove il dettaglio conta, consegniamo il Q4.
                </p>
            </div>
            <div class="row g-4 pt-2">
                <?php foreach ($livelli_finitura as $i => $lv): ?>
                <div class="col-md-6 col-lg-3 reveal" style="transition-delay: <?php echo $i * 0.12; ?>s">
                    <div class="card-finitura<?php echo !empty($lv['firma']) ? ' firma' : ''; ?>">
                        <?php if (!empty($lv['firma'])): ?>
                        <span class="badge-firma"><i class="bi bi-star-fill" aria-hidden="true"></i> La nostra firma</span>
                        <?php endif; ?>
                        <span class="livello"><?php echo $lv['livello']; ?></span>
                        <h5><?php echo $lv['titolo']; ?></h5>
                        <p><?php echo $lv['testo']; ?></p>
                        <div class="barra-livello"><span style="width: <?php echo ($i + 1) * 25; ?>%"></span></div>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
            <div class="banner-metodo reveal">
                <img src="../assets/img/servizi/cartongesso-stuccatura.jpg"
                     alt="Stuccatura dei giunti del cartongesso con la spatola"
                     loading="lazy">
                <div class="velo" aria-hidden="true"></div>
                <span class="badge-qualita">
                    <i class="bi bi-tools" aria-hidden="true"></i> Il metodo in cantiere
                </span>
                <div class="didascalia">
                    <h5>La stuccatura è un gesto di precisione</h5>
                    <p>Spatola, cura e pazienza: è così che un giunto scompare e la parete diventa un'unica superficie.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="text-center mb-5 reveal">
                ...
                <p class="mt-3 mx-auto" style="max-width: 640px;">
                    Il cartongesso si adatta a casa, ufficio e spazi commerciali.
                    Questi sono i contesti in cui portiamo più spesso la nostra firma.
                </p>
            </div>
            <div class="row g-4">
        ...
        <div class="container">
            <div class="row align-items-center g-4">
                <div class="col-lg-7 reveal">
                    <h2 class="mb-2">Hai un progetto in cartongesso?</h2>
                    <p class="fs-5 mb-4" style="color:rgba(255,255,255,.9)">
                        <em>"<?php echo $tagline; ?>"</em> — richiedi subito un
                        <strong>preventivo gratuito</strong> e senza impegno per le tue opere in cartongesso.
                    </p>
    ...
    <section id="faq">
        <div class="container">
            <div class="text-center mb-5 reveal">
                ...
                <h2 class="section-title mt-3">FAQ sul Cartongesso</h2>
                <div class="title-underline"></div>
            </div>
